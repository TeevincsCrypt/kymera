...
export function DashboardControlPlane() {
  ...
  if (!address) return <section className="rounded-2xl border border-[#e9e7e2] bg-[#24211f] p-5 text-[#fffaf5]"><p className="text-sm font-semibold">Connect your wallet to load dashboard metrics.</p><p className="mt-1 text-sm text-[#d6d0ca]">Stats and security state are scoped to the connected wallet.</p></section>
